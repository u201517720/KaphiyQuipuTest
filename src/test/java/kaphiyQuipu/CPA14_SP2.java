...
public class CPA14_SP2 {
	...
	public void Test() throws InterruptedException {
		...
		WebElement Buscarbtn1 = driver.findElement(By.xpath("//button[@class=\"btn btn-primary mr-1 mb-1\"]"));
		Buscarbtn1.click();
		
		Thread.sleep(3000);
		
		WebElement Number = driver.findElement(By.xpath("//li[@class=\"pages ng-star-inserted\"][2]"));
		Number.click();
		
		Thread.sleep(3000);
		
		WebElement OrdenProcesolnk = driver.findElement(By.xpath("//a[@href=\"/acopio/operaciones/ordenproceso/update/21\"]"));
		OrdenProcesolnk.click();
		
		Thread.sleep(3000);
		
		WebElement GenerarGRemision = driver.findElement(By.xpath("//button[@class=\"btn btn-primary mr-1 ng-star-inserted\"]"));
		GenerarGRemision.click();
		
		Thread.sleep(3000);
		
		WebElement Confirmbtn2 = driver.findElement(By.xpath("//button[@class=\"swal2-confirm swal2-styled\"]"));
		Confirmbtn2.click();
