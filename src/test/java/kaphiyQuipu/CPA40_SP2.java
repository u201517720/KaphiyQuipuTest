...
public class CPA40_SP2 {
	...
	public void Test() throws InterruptedException {
		...
		WebElement Module2 = driver.findElement(By.xpath("//span[text()=\"Notas de Salida\"]"));
		Module2.click();
		...
		WebElement NotaIngreso = driver.findElement(By.xpath("//a[@href=\"/planta/operaciones/notasalida/update/18\"]"));
		NotaIngreso.click();
		...
		WebElement GenNotaSalida = driver.findElement(By.xpath("//button[@class=\"btn btn-primary mr-1\"]"));
		GenNotaSalida.click();
