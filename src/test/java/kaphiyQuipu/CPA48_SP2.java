...
public class CPA48_SP2 {
	...
	public void Test() throws InterruptedException {
		...
		WebElement NotaIngreso = driver.findElement(By.xpath("//a[@href=\"/acopio/operaciones/notaingresodevolucion/update/18\"]"));
		NotaIngreso.click();
		
		Thread.sleep(3000);
		
		WebElement GenGuiaRemision = driver.findElement(By.xpath("//button[@class=\"btn btn-primary mr-1 ng-star-inserted\"]"));
		GenGuiaRemision.click();
