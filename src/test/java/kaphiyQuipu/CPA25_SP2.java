...
public class CPA25_SP2 {
	...
	public void Test() throws InterruptedException {
		...
		Userbox.clear();
		Userbox.sendKeys("ovanguloc@gmail.com");
		...
		WebElement ConfirmRecepcion = driver.findElement(By.xpath("//button[@class=\"btn btn-primary mr-1 ng-star-inserted\"]"));
		ConfirmRecepcion.click();
