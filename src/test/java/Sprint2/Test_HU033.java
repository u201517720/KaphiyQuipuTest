...
public class Test_HU033 extends BaseTest {
	@Before
	public void InitTest() throws InterruptedException
	{
		AbrirLink();
		super.email = "aasisdl@gmail.com";
		super.password = "P@ssw0rd100";
		IniciarSesion();
	}
	
	@OrderedTest(order=1)
	public void Test_ProyectarCosechasAcopiador_SistemaMuestraCosechaProyectada() throws InterruptedException {
		WebElement Module1 = driver.findElement(By.xpath("//span[text()=\"Proyecciones\"]"));
		Module1.click();
		
		Thread.sleep(500);
		
		WebElement Module2 = driver.findElement(By.xpath("//span[text()=\"Cosechas\"]"));
		Module2.click();
